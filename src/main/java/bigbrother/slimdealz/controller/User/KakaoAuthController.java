...
public class KakaoAuthController {
    ...
    private HttpHeaders createCookies(String jwtToken, String refreshTokenJwt, String kakaoId) {
        ...
        String jwtCookie = "jwtToken=" + jwtToken + "; Path=/; Domain=.slimdealz.com; SameSite=None; Secure";
        String refreshCookie = "refreshToken=" + refreshTokenJwt + "; Path=/; Domain=.slimdealz.com; SameSite=None; Secure";
        String kakaoIdCookie = "kakaoId=" + kakaoId + "; Path=/; Domain=.slimdealz.com; SameSite=None; Secure";
